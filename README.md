...
It allows users to convert temperatures between **Celsius** and **Fahrenheit** instantly.
...
2. Select the unit (Celsius or Fahrenheit)
3. Click on **Convert**
4. The converted temperature is displayed instantly
